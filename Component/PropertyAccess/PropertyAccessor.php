...
class PropertyAccessor implements PropertyAccessorInterface
{
     ...
     * @return bool
     */
    protected function checkValueIsCollection(
        $object,
        $property,
        $value,
        $reflClass,
     ...
     * @return bool
     */
    protected function checkValueIsCollectionByMethods(
        $object,
        $property,
        $value,
        $addMethod,
     ...
     * @param string $addMethod The add*() method
     * @param string $removeMethod The remove*() method
     * @param bool $shouldRemoveItems Flag that tells if we want to remove existing items
     */
