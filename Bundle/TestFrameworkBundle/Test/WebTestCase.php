...
abstract class WebTestCase extends BaseWebTestCase
{
     ...
     */
    protected static $class = 'App\\Kernel';
     ...
     * @return array
     */
    public static function getJsonResponseContent(
        Response $response,
        $statusCode,
        string $message = ''
    ) {
     ...
     * @param string $message
     */
    protected static function assertEmptyResponseStatusCodeEquals(
        Response $response,
        $statusCode,
        string $message = ''
    ) {
     ...
     * @param string $message
     */
    protected static function assertJsonResponseStatusCodeEquals(
        Response $response,
        $statusCode,
        string $message = ''
    ) {
     ...
     * @param string $message
     */
    protected static function assertHtmlResponseStatusCodeEquals(
        Response $response,
        $statusCode,
        string $message = ''
    ) {
    ...
    protected static function assertResponseStatusCodeEquals(
        ...
        try {
            TestCase::assertEquals($statusCode, $response->getStatusCode(), $message);
    ...
    protected static function assertResponseContentTypeEquals(
        ...
        TestCase::assertTrue($response->headers->contains('Content-Type', $contentType), $message);
    }
     ...
     * @param string $message
     */
    protected static function assertArrayIntersectEquals(
        array $expected,
        array $actual,
        string $message = ''
    ) {
