...
use Oro\Bundle\DataGridBundle\Security\Authentication\TokenAccessorInterface;
...
use Oro\Bundle\DataGridBundle\Security\ORM\Walker\AclHelper;
...
class GridViewsExtension extends AbstractExtension
{
    ...
    public function __construct(
        ...
        $this->managerLink = $gridViewManager;
    }
    ...
    public function visitMetadata(DatagridConfiguration $config, MetadataObject $data)
    {
        ...
        $gridViews = $this->managerLink->getAllGridViews($currentUser, $gridName);
